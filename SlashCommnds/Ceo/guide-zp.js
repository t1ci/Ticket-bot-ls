...
module.exports = {
    ...
    .setName('guide-zp')
   .setDescription('get zp-team guides'),
...
return interaction.reply({content: "Check your permissions for your own", ephemeral: true});
   ...
   const embed11 = new EmbedBuilder()
     .setDescription(`https://lsgamerz.net/topic/11466-vouches-and-feedback-😎/
https://lsgamerz.net/topic/19095-zpze-claim-of-ammopacks-per-month/
https://lsgamerz.net/forum/187-verification-of-bans/
https://lsgamerz.net/topic/22928-zpze-command-menu-2024/
https://lsgamerz.net/topic/22364-zp-an-important-guidewarns/`)
     .setColor(`Random`);
//.setFooter({ text: 'VisioCrafters', iconURL: 'https://media.discordapp.net/attachments/1125565245990121544/1184283825803632650/1702424261750.png?ex=658b6943&is=6578f443&hm=fc2fe78a12e132633bcaf07d97c1895306389b604f3c16e9ac4ceb8c4d50d687&' });
   ...
   interaction.channel.send({content: `TA & Admins must check this `, embeds: [embed11]});
 }
}